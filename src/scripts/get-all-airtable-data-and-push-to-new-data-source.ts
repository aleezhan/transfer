...
async function getAllAirtableDataAndPushToNewDataSource(apiKey: string, baseId: string, tableId: string, lookbackPeriod: number, clientEmail: string, privateKey: string, sheetId: string) {
...
async function run() {
    ...
    const sheetId: string = argv[ARG_SHEET_ID];
